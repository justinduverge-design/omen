# Phase 1.5h/1.5g — Multi-Color Palette + Motif + Moment WCAG Sweep

**Date:** 2026-06-25
**Phase:** 1.5h multi-role palettes + 1.5g motif hairline guard + 1.5g.3 cultural-moment eyebrow/tint guard
...
- **moment:<id>/eyebrow** — cultural-moment eyebrow color on the team surface. Decorative chrome label (paired with a mock badge that carries the message), so AA-large ≥ 3.0.
- **moment:<id>/post-tint-body** — body text on the moment-tinted surface (`color-mix` ≤0.18 alpha). Load-bearing legibility — AA-normal ≥ 4.5.
...
| Team | Variant | Surface | Accent | Anchor | body/surf | accent/surf | CTA/acc | motif/surf | moment |
|---|---|---|---|---|---|---|---|---|---|
...
| **DET** Detroit Lions | official (Lions) | `#0076B6` | `#B0B7BC` | — | 4.34 FAIL | 2.42 FAIL | 9.75 AAA | — | det-thanksgiving-classic/eyebrow: 4.34 AA |
| **DET** Detroit Lions | special (8 Mile) | `#0076B6` | `#A8AFB4` | Motor City / 8 Mile | 4.34 FAIL | 2.22 FAIL | 8.91 AAA | — | det-thanksgiving-classic/eyebrow: 4.11 AA |
| **GB** Green Bay Packers | official (Packers) | `#203731` | `#FFB612` | — | 11.20 AAA | 7.23 AAA | 11.26 AAA | gb-gold-tundra-hairline: 7.23 AAA | gb-lambeau-tundra/eyebrow: 7.23 AAA |
| **GB** Green Bay Packers | special (Lambeau Tundra) | `#1A2E27` | `#FFB612` | Lambeau Field tundra | 12.64 AAA | 8.16 AAA | 11.26 AAA | gb-gold-tundra-hairline: 8.16 AAA | gb-lambeau-tundra/eyebrow: 8.16 AAA |
...
| **NO** New Orleans Saints | special (Mardi Gras) | `#0F0F12` | `#5D2E8C` | Mardi Gras Krewe traditions | 16.87 AAA | 2.04 FAIL | 8.28 AAA | no-cream-hairline: 16.68 AAA | no-mardi-gras/eyebrow: 10.34 AAA<br>no-mardi-gras/post-tint-body: 15.13 AAA |
