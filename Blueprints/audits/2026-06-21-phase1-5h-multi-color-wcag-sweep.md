# Phase 1.5h — Multi-Color Palette WCAG Sweep

**Date:** 2026-06-21
**Phase:** 1.5h — Multi-role official palettes + special cultural variants
...
| Team | Variant | Surface | Accent | Anchor | body/surf | accent/surf | CTA/acc |
|---|---|---|---|---|---|---|---|
...
| **MIA** Miami Dolphins | official (Dolphins) | `#FDF8F2` | `#008E97` | — | 18.74 AAA | 3.74 AA | 5.01 AA |
| **MIA** Miami Dolphins | special (Calle Ocho) | `#FAEFD6` | `#E91E63` | Calle Ocho / Little Havana | 17.32 AAA | 3.81 AA | 4.55 AA |
...
| **PIT** Pittsburgh Steelers | official (Steelers) | `#101820` | `#FFB612` | — | 15.77 AAA | 10.18 AAA | 11.26 AAA |
| **PIT** Pittsburgh Steelers | special (US Steel) | `#0D0F12` | `#FFB612` | US Steel logo origin | 16.92 AAA | 10.92 AAA | 11.26 AAA |
...
| **GB** Green Bay Packers | official (Packers) | `#203731` | `#FFB612` | — | 11.20 AAA | 7.23 AAA | 11.26 AAA |
| **GB** Green Bay Packers | special (Lambeau Tundra) | `#1A2E27` | `#FFB612` | Lambeau Field tundra | 12.64 AAA | 8.16 AAA | 11.26 AAA |
...
| **NO** New Orleans Saints | official (Saints) | `#101820` | `#D3BC8D` | — | 15.77 AAA | 9.67 AAA | 10.69 AAA |
| **NO** New Orleans Saints | special (Mardi Gras) | `#0F0F12` | `#5D2E8C` | Mardi Gras Krewe traditions | 16.87 AAA | 2.04 FAIL | 8.28 AAA |
...
node frontend/scripts/contrast-sweep.mjs \
     --out Blueprints/audits/2026-06-21-phase1-5h-multi-color-wcag-sweep.md
```