# Screen contract - CommandQuietStraight

Compiled from `design/native-visual-lock-2026-09-13/CommandQuietStraight.dc.html` on 2026-09-14 using `_shared.css` hash `5f66e0a5c23a`. Source hash `f5fd6ba2e3fc`.

## Build binding

| Field | Value |
|---|---|
| Artboard title | Command — quiet, straight |
...
| Governing rule | V-QuietWeekStraight resolved here: straight variant fires on loss, injury, provider failure, or unknown quiet inputs |
...
- `Command`
- `JD`
- `Rough week. Nothing worth moving for.`
- `You lost by four, Achane is out, and there is nobody on the wire who fixes that. Holding is the call.`
- `CONFIDENT`
- `LOW RISK`
- `NEXT READ · TUESDAY 3:00 AM WAIVERS`
- `5th of 12. One game off the cut with six to play.`
- `Omen`
- `Trade`
- `League`
...
|  E014 | `.screen > div.sbody:nth-of-type(1) > div.top:nth-of-type(3) > div:nth-of-type(1)` |  | NativeStack | body | text-primary | transparent | text-primary | 16,84 166x38 | pad 0/0/0/0; margin 0/0/0/0; gap 0  |
|  E015 | `.screen > div.sbody:nth-of-type(1) > div.top:nth-of-type(3) > div:nth-of-type(1) > p.kick:nth-of-type(1)` | Week 9 · After a loss | Text | micro | accent | transparent | accent | 16,84 166x12 | pad 0/0/0/0; margin 0/0/4/0; gap 0  |
|  E016 | `.screen > div.sbody:nth-of-type(1) > div.top:nth-of-type(3) > div:nth-of-type(1) > h2.ttl:nth-of-type(1)` | Command | Text.heading | screen-title | text-primary | transparent | text-primary | 16,100 166x22 | pad 0/0/0/0; margin 0/0/0/0; gap 0  |
...
|  E018 | `.screen > div.sbody:nth-of-type(1) > div.quiet:nth-of-type(4)` |  | NativeStack | body | text-primary | transparent | text-primary | 0,122 390x278 | pad 32/24/0/24; margin 0/0/0/0; gap 12  |
...
|  E025 | `.screen > div.sbody:nth-of-type(1) > div.quiet:nth-of-type(4) > h3.qh:nth-of-type(1)` | Rough week. Nothing worth moving for. | Text.heading | h2 | text-primary | transparent | text-primary | 24,222 342x45 | pad 0/0/0/0; margin 0/0/0/0; gap 0  |
|  E026 | `.screen > div.sbody:nth-of-type(1) > div.quiet:nth-of-type(4) > p.qp:nth-of-type(1)` | You lost by four, Achane is out, and there is nobody on the wire who fixes that. Holding is the call. | Text | name | text-secondary | transparent | text-secondary | 72,278 246x59 | pad 0/0/0/0; margin 0/0/0/0; gap 0  |
|  E027 | `.screen > div.sbody:nth-of-type(1) > div.quiet:nth-of-type(4) > div.meta:nth-of-type(1)` |  | NativeStack | body | text-primary | transparent | text-primary | 107,352 176x12 | pad 0/0/0/0; margin 2/0/0/0; gap 14  |
|  E028 | `.screen > div.sbody:nth-of-type(1) > div.quiet:nth-of-type(4) > div.meta:nth-of-type(1) > span.band.b-conf:nth-of-type(1)` | Confident | ConfidenceBand | micro | accent-hover | transparent | accent-hover | 107,352 96x12 | pad 0/0/0/0; margin 0/0/0/0; gap 6  |
|  E029 | `.screen > div.sbody:nth-of-type(1) > div.quiet:nth-of-type(4) > div.meta:nth-of-type(1) > span.rk.lo:nth-of-type(2)` | Low risk | Text | label | text-tertiary | transparent | text-tertiary | 217,352 66x12 | pad 0/0/0/0; margin 0/0/0/0; gap 6  |
|  E030 | `.screen > div.sbody:nth-of-type(1) > div.quiet:nth-of-type(4) > p.qmeta:nth-of-type(2)` | Next read · Tuesday 3:00 AM waivers | Text | micro | text-tertiary | transparent | text-tertiary | 56,378 277x12 | pad 0/0/0/0; margin 2/0/10/0; gap 0  |
|  E031 | `.screen > div.sbody:nth-of-type(1) > div.spacer:nth-of-type(5)` |  | NativeStack | body | text-primary | transparent | text-primary | 0,400 390x339 | pad 0/0/0/0; margin 0/0/0/0; gap 0  |
|  E032 | `.screen > div.sbody:nth-of-type(1) > div.oneline:nth-of-type(6)` |  | NativeStack | body | text-primary | transparent | border-subtle | 16,739 358x28 | pad 10/0/0/0; margin 0/16/0/16; gap 10  |
|  E033 | `.screen > div.sbody:nth-of-type(1) > div.oneline:nth-of-type(6) > span.tx:nth-of-type(1)` | 5th of 12. One game off the cut with six to play. | Text | body-sm | text-secondary | transparent | text-secondary | 16,750 358x17 | pad 0/0/0/0; margin 0/0/0/0; gap 0  |
