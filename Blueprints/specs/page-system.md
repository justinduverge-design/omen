...
3. **`/draft` "Preview Mode — example recommendations" yellow banner** — hides Justin's signal that he doesn't want a "preview" label here; the demo experience belongs to Phase 1.11 / Phase 2.7 (Demo Mode UI), not a banner on the live page. Remove. → **Phase 1.10, not yet actioned — needs explicit Justin go-ahead since removing it drops the mock/live disclosure on that page; raised 2026-06-25, awaiting decision.**
