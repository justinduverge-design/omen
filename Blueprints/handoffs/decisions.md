...
- Font system locked — Cormorant Garamond (`font-display` + `font-serif`, h1/h2 and brand/serif moments) + Alegreya Sans (`font-sans`, body/UI) + DM Mono (`font-mono`, data/numbers). PR #22 corrected the prior spec (Barlow Condensed + DM Sans) to match `Brand/brand-system.md`. `tailwind.config.js` and `index.css` updated. Closed 2026-06-02.
