...
Operational procedures for using SLOPS skills against Corvus. These files apply Layer 0 workflows to the Layer 2 product without copying or redefining the canonical skills.

## Start Here

1. `corvus-company-baseline.md` — required lifecycle for turning Corvus work into a reusable company baseline.
...
4. `post-live-technology-learning.md` — parked until Corvus is live plus seven stable days; teaches why the stack exists and creates an in-season improvement backlog.
...
- These playbooks decide when Corvus invokes those skills and what evidence must be retained.
