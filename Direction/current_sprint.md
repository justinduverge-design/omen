...
### Backend — Phase 3
- [ ] **Phase 3.12 — Tailscale → KVM2 Gemma 4-E4B bridge** for narration. `LLM_BASE_URL` already in env inventory. Cost: medium. Done docs: feature + security. **In merge elsewhere; do not duplicate unless Justin re-pins.**
