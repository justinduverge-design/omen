...
| M1-P | Native primitives + component enforcement | P0 | M1 focus-ring + typography briefs ✅; authority reconciliation first | **New gate for M4 screen work.** Deliver P1 authority reconciliation, P2 shared foundation primitives, P3 first Omen compositions, and P4 dual-platform gallery/enforcement in small PRs. Source: `Blueprints/specs/mobile/m1-native-primitives-enforcement-v1.md`. No feature-local primitive clones or unapproved compositions. |
