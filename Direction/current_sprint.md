...
- **⛔ STILL OPEN — named rollback owner.** Cannot be closed by an agent. This item's own text says "'named owner' means a person", and facts-of-record #14 says authorization is not evidence. **Justin must be named on the record.** `A4`'s sixth evidence gate reads "completed O2 rollback exercise *with Justin as owner*" — the exercise is now complete; the owner clause is not.
