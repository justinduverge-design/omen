...
- **Evidence:** `Direction/reviews/2026-08-24-a7-owned-football-data-pipeline.md` remains valid for source rights, immutable inputs, identity, operations, and base-format formula replays. It is not sufficient evidence for full league fidelity because its derived rules cover only Standard/Half PPR/PPR and explicitly defer kicker/DST rules. No collector, timer, deploy, dependency, credential, SQL, migration, or production change occurred.
