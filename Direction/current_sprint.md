...
- **Batch 3 (final):** DecisionBrief shell — integrates Batch 1 + provider state; all 8 state surfaces. Preparation brief: `Blueprints/specs/mobile/m1-p-p3-decision-brief-shell-brief-v1.md`.
