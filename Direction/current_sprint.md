...
| M1-P | Native primitives + component enforcement | P0 | M1 focus-ring + typography briefs ✅; authority reconciliation first | **New gate for M4 screen work.** P1 authority reconciliation is complete. Next: approved Figma reference/wireframe/golden-screen pass, then P2 shared foundation primitives, P3 first Omen compositions, and P4 dual-platform gallery/enforcement in small PRs. Sources: `m1-native-primitives-enforcement-v1.md`, `m1-native-reference-library-v1.md`, and `m1-figma-screen-contract-pass-v1.md`. No feature-local primitive clones or unapproved compositions. |
