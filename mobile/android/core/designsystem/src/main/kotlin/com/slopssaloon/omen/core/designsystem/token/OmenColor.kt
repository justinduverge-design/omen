...
val OmenDarkColors = OmenColorScheme(
    bg = Color(0xFF1F1F1D),
    surface1 = Color(0xFF2A2A27),
    surface2 = Color(0xFF343431),
    surface3 = Color(0xFF3F3F3B),
    border = Color(0xFF8A8272),
    borderSubtle = Color(0xFF3A3A36),
    textPrimary = Color(0xFFF5F0E8),
    textSecondary = Color(0xFFBDB5A9),
    textTertiary = Color(0xFFA79E90),
    accent = Color(0xFFC4933B),
    accentHover = Color(0xFFD8A648),
    accentMuted = Color(0xFF3A2A0A),
    textOnAccent = Color(0xFF14140F),
    omen = Color(0xFF2F7D5B),
    omenChip = Color(0xFF4FAE81),
    umber = Color(0xFF5A3A25),
    focusRing = Color(0xFFC4933B),
    focusRingHalo = Color(0xFFC4933B).copy(alpha = 0.4f),
